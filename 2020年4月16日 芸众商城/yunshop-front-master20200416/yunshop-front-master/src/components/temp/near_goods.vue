  ...
  <div id="goods">
    ...
    >
      ...
      <div v-if="datas.params.style === 'hotel'">
        <div
          id="checkinout"
          style=" border: solid #cccccc 0.0625rem; border-width:0.0625rem 0;"
        >
          <a
            id="selinTime"
          ...
          >
            <div style="float:left; width:40%;">
              <span
                style="background:#f5f5f5; display:block; float:left; height:2.5rem; width:3.75rem; color:#999999; padding:0 0.3125rem 0 0.625rem;"
                >入住:&nbsp;</span
              >
              <span
                id="CheckInDay"
