  ...
  <div id="goods">
    <div class="fe-mod fe-mod-8"
        ...
        <div v-for="(good,i) in $store.state.temp.item.data[index].data"
          ...
          <div class="fe-mod-8-good good-new"
               :style="{
                 ...
                 marginRight:(datas.params.style=='50%'||datas.params.style=='49.5%')&&(i+1)%2=='0'?'0':datas.params.style=='33.3%'&&(i+1)%3=='0'?'0':'2%'
               }">
            <a @click.stop.prevent="gotoDetail(good)"
              ...
              <div class="fe-mod-8-main">
                ...
                <div class="card-price"
                  ...
                  <span v-if="!(datas.params.style=='100%'||datas.params.style=='50%'||datas.params.style=='49.5%')"></span>￥{{ good.vip_level_status&&good.vip_level_status.status==1?good.vip_level_status.word:good.pricenow }}
                  <div>
                    <span style="text-decoration: line-through; font-size: 12px; color: #808080;"
                          ...
                          v-if="datas.params.price == 3 ||(datas.params.price == 1 &&good.priceold != good.pricenow &&good.priceold > 0)"><span v-if="!(datas.params.style=='100%'||datas.params.style=='50%'||datas.params.style=='49.5%')"></span>￥{{ good.priceold }}</span>
                ...
                <div class="card-price colorBlack"
                  ...
                  <span v-if="datas.params.style=='100%'||datas.params.style=='50%'||datas.params.style=='49.5%'">会员价</span><span v-else>会</span>:<span>￥</span>{{ good.vip_level_status&&good.vip_level_status.status==1?good.vip_level_status.word:good.price_level==1?good.vip_price:good.vip_next_price }}
                </div>
                <div class="card-price"
              ...
              <div class="statusShow">
                <div v-if="good.stock_status==1" class="statusShowLi">售罄</div>
                <div v-if="good.stock_status==2" class="statusShowLi">已下架</div>
                <div v-if="good.stock_status==3" class="statusShowLi">不存在</div>
                <div v-if="good.stock_status==4" class="statusShowLi">不存在</div>
              </div>
            </a>
          </div>
        </div>
                ...
                <div class="price fe-mod-8-main-name">
                  <div v-show="datas.params.price != 0">
                    <div class="p1"
                      ...
                      ￥{{ good.vip_level_status&&good.vip_level_status.status==1?good.vip_level_status.word:good.pricenow }}
                    </div>
                    ...
                    <div class="p3"
                         v-show="datas.params.price == 3">
                      会员价：<span>￥</span>{{ good.vip_level_status&&good.vip_level_status.status==1?good.vip_level_status.word:good.price_level==1?good.vip_price:good.vip_next_price }}
                    </div>
                  </div>
                  <div class="p4"
                       v-if="datas.params.love == 1 && good.award == 1 && (!good.vip_level_status || (good.vip_level_status && good.vip_level_status.status==0))">
      ...
      <div v-if="datas.params.style === 'hotel'">
        <div id="checkinout"
             style="border:0.0625rem solid #cccccc;">
          <a id="selinTime"
             style="font-weight: normal;  display: block; height:2.5rem; line-height:2.5rem; padding:0 0rem;background:#fff"
