            ...
            <div class="list">
              ...
              <div class="store-intro">
                ...
                <div class="a06 a8r">
                  <strong class="i8">
                    <span class="da">{{
                      items.dispatch.substring(0, items.dispatch.length - 1)
                    }}</span>
                  </strong>
                </div>
                <div class="a8v">
                ...
                <div class="discount">
                  <p>
                    ...
                    <span
                      v-if="
                        items.store_point.point_deduct_switch == 0
                          ? false
                          : true
                      "
            ...
            <div class="fe-mod-8-hp-line-info">
              ...
              <div class="price fe-mod-8-main-name">
                <div>
                  ...
                  <div class="p2">￥{{ item.market_price }}</div>
                  <!--<div class="p3">-->
                  <!--会员价：100.00-->
                  <!--</div>-->
                </div>
