...
export default {
  ...
  get(url, params, message) {
    ...
    if ((window.location.href.indexOf("scope") > -1 && window.location.href.indexOf("appid") > -1 && window.location.href.indexOf("mob_parent") > -1 && window.location.href.indexOf("mob_user") > -1 && window.location.href.indexOf("timetamp") > -1 && window.location.href.indexOf("sign") > -1)) {
