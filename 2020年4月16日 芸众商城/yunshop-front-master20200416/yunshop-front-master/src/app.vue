<template>
  <div id="app">
    ...
    <div id="returnLiveBtn" v-if="isShowReturnLiveBtn" @click.stop="gotoLiveRoom">
     <i class="fa fa-angle-left"></i><span class="rlbtext">返回直播</span>
    </div>
...
export default {
  data() {
    return {
      ...
      is_Inviter: "",
      invite_mobile: "",
      transitionApp: 'slide-left' // add 过场动画 2020年4月19日
    };
  },
  provide() {
    return {
  ...
  watch: {
    ...
    $route(to, from) {
      ...
      if (this.$router.isBack) {
            this.transitionApp = "slide-right";
      } else {
          this.transitionApp = "slide-left";
      }
