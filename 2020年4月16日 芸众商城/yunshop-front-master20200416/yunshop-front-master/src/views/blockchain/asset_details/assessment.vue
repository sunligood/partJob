    ...
    <div class="middle">
      ...
      <div class="box_a" v-if="currentTab === 'assess'">
        ...
        <div class="new_assess" v-if="assess_data.last_worth">
          <ul class="assess">
            <li>最新评估价值</li>
            <li><span>¥</span>{{ assess_data.last_worth }}</li>
          </ul>
        </div>
        <div
          class="down_report"
      ...
      <div class="box_d" v-if="currentTab === 'digitization'">
        ...
        <div class="chart1">
          ...
          >
            <!--:XData="digitization_Data.subscription_price.week"-->
            <ECharts
              :id="'echarts1'"
        ...
        <div class="chart">
          ...
          >
            <!--:XData="digitization_Data.sell_price.week"-->
            <ECharts
              :id="'echarts2'"
              :text="'拍卖价格曲线'"
        ...
        <div class="purchase">
          <yd-rollnotice autoplay="2000">
            <yd-rollnotice-item
              v-for="(item,i) in digitization_Data.subscribe_record" :key='i'
        ...
        <div class="buy_btn">
          <yd-button type="primary" v-if="can_subscribe" @click.native="tobuy"
            >我要{{ lang.subscription_name }}</yd-button
          >
          <yd-button type="primary" @click.native="tosell">我要拍卖</yd-button>
          <yd-button type="primary" @click.native="auction">拍卖中</yd-button>
        </div>
      ...
      <div class="box_e" v-if="currentTab === 'bonus'">
        <div class="sum">
          <ul class="bonus">
            <li>
              {{ lang.capital_name }}总{{ lang.bonus_name }}金额：¥
            ...
            <li>
              单人累计最高{{ lang.bonus_name }}金额：¥{{
                profit.max_member || 0
              }}
            </li>
            <!--<li>原始单资产累计分红金额：¥{{profit.init_accumlative_momery}}</li>-->
          </ul>
        </div>
        <div>
          <div
          ...
          >
            ...
            <ul class="record">
              <li>
                <span>分红金额：¥{{ item.amount }}</span>
                <span>{{ item.created_at }}</span>
              </li>
              <li>单{{ lang.capital_name }}价值：¥{{ item.unit_amount }}</li>
              <li>
                发行{{ lang.capital_name }}总量：¥{{ item.useable_amount }}
              </li>
            </ul>
          </div>
        </div>
          ...
          >
            ...
            <dd class="s3">
              <p class="s1">
                ...
                <span class="s2">￥{{ item.market_price }}</span>
              </p>
            </dd>
          </dl>
        </div>
