...
export default {
  ...
  methods: {
    ...
    setCity(areaname) {
      if(this.$route.query.tag == "hotel"){
        this.city = areaname;
        this.$router.push(this.fun.getUrl('o2oCity', {}, {city: areaname,tag:"hotel"}));
      }if(this.$route.query.tag == "appointment"){
        this.$router.push(this.fun.getUrl('o2oCity',{},{city: areaname,tag:"appointment"}));
      }else{
        this.city = areaname;
