                                    ...
                                    <div class="selectgoods">
                                        <div class="selectgoodsleft" v-if="!fun.isTextEmpty(selectgoodsData)">
                                            ...
                                            <div class="gocenter">
                                                ...
                                                <div class="fobottom">
                                                    <div class="foleft">
                                                        <div class="pic">¥{{selectgoodsData.price}}</div>
                                                        <div class="delpic">¥{{selectgoodsData.market_price}}</div>
                                                    </div>
                                                    <div class="foright">
...
<!--                    <div class="right">搜索</div>-->
            ...
            <van-popup :overlay="false" v-model="addgoodslistshow" position="right" style="width: 100%;height: 100%" id="scrollGoods">
                            ...
                            <ul >
                                <li v-for="(item,index) in goodslistData" @click="setGoodsId(item.id)" v-if="!fun.isTextEmpty(item)" :key='index'>
                                    ...
                                    <div class="center">
                                        ...
                                        <div class="bottom">
                                            <div class="picleft">¥{{item.price}}</div>
                                            <div class="picright">原价：¥{{item.market_price}}</div>
                                        </div>
                                    </div>
        ...
        <van-popup :overlay="false" v-model="storeshow" position="right" style="width: 100%;height: 100%" id="scrollstore">
            <div class="storelist">
                ...
                <mt-loadmore :top-method='loadTopStore' :bottom-method="loadBottomStore" :bottom-all-loaded="allLoadedStore" bottomPullText="" bottomDropText="下拉加载" bottomLoadingText="" topDropText="释放刷新" ref="loadmoreStore">
                    <div class="astorelist_list">
                        <ul>
                            <li v-for="(item,index) in storelistData" :key='index' @click="setStoreId(item.id)" v-if="!fun.isTextEmpty(selectgoodsData)">
                                <div class="left" >
                                    <img :src="item.thumb" alt="">
                                </div>
                                <div class="center">
