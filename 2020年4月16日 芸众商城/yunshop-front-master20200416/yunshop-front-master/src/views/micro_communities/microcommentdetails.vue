<template>
  <div id="microcommentdetails">
    ...
    <div class="banner"
         v-if="detailsData.has_many_image">
      <viewer :images="detailsData.has_many_image" style="background-color:#333;" class="section">
    ...
    <div class="details_show">
      <div class="user_message">
        <div class="user_left">
          <div class="pic"
            ...
            <img :src="detailsData.has_one_stick_user.avatar"
                 alt=""
                 @click="gotoHome(detailsData.has_one_stick_user.uid)"/>
          </div>
        ...
        <div class="uset_right">
          <div class="attention"
               @click="attentionBtn"
               v-if="detailsData.is_own!=1">
            {{ detailsData.is_follow ? "已关注" : "关注" }}
          </div>
          <div class="more"
               @click="managementBtn">
            <img src="../../assets/images/micro_communities/detail_more@2x.png"
                 alt=""/>
          </div>
        </div>
      </div>
      <div class="article">{{ detailsData.contents }}</div>
      ...
      <div class="loca_information">
        <div class="localeft">
          <div class="letimg">
            <img src="../../assets/images/micro_communities/publish_add_address@2x.png"
                 alt=""/>
          </div>
          <div class="addressname">{{ detailsData.address }}</div>
        </div>
        <div class="locaright">
          浏览：{{ detailsData.browse_num ? detailsData.browse_num : 0 }}
        </div>
      </div>
      <div class="showmessage">
        <div class="content">
          <div class="shopshow"
               @click="gotoStore(detailsData.has_one_store.arr.id)"
               v-if="detailsData.has_one_store">
            <div class="leftimg">
              <img :src="detailsData.has_one_store.arr.thumb"
                   alt=""/>
            </div>
            <div class="shopright">
              <div class="name">
          ...
          <div class="goodsshow"
               v-if="detailsData.has_one_goods"
               @click="gotoGoods(detailsData.has_one_goods.id)">
            <div class="leftimg">
              <img :src="detailsData.has_one_goods.thumb"
                   alt=""/>
            </div>
            <div class="goodright">
              <div class="goodsname">{{ detailsData.has_one_goods.title }}</div>
              <div class="fobottom">
                <div class="foleft">
                  <div class="pic">¥{{ detailsData.has_one_goods.price }}</div>
                  <div class="delpic">
                    ¥{{ detailsData.has_one_goods.market_price }}
                  </div>
                </div>
                <div class="foright">
                  <div class="sold">
                    已售{{ detailsData.has_one_goods.show_sales }}件
                  </div>
                </div>
              </div>
            </div>
          ...
          <ul class="maincomment">
            <li v-for="(item, index) in StickCommentData" :key='index'>
              <div class="maincommentleft"
                ...
                ">
                <img v-if="item.has_one_comment_user"
              ...
              <div class="maincommentright">
                  ...
                  <div class="thumb_up"
                    ...
                    <div class="thumb_img">
                      <template v-if="item.is_praise">
                        <img src="../../assets/images/micro_communities/home_praise_cur@2x.png"
                             alt=""/>
                      </template>
                      <template v-else>
                        <img src="../../assets/images/micro_communities/home_praise@2x.png"
                             alt=""/>
                      </template>
                    </div>
                ...
                <template v-if="item.child"
                  ...
                  <div class="deputy_comment"
                       @click="
                      replyCommentsBtn(
                        childitem.major_cm_id,
                        childitem.id,
                        childitem.uname,
                        childitem.content,
                        childitem.is_own
                    ...
                    <div class="deputy_comment_left"
                         v-if="childitem.has_one_comment_user">
                      <img :src="childitem.has_one_comment_user.avatar"
                           alt=""/>
                    </div>
...
"
    ...
    <div class="bottom_operation set-pc-styleLeft">
      <div class="content">
        <div class="reply"
             @click="subMainCommentBtn">
          <div class="reply_left">
            <img src="../../assets/images/micro_communities/home_autograph@2x.png"
                 alt=""/>
          </div>
          <div class="reply_right">
            说点什么...
        ...
        <div class="appreciate"
          ...
          <div class="appreciateimg">
            <img src="../../assets/images/micro_communities/detail_reward@2x.png"
                 alt=""/>
          </div>
        ...
        <div class="comment">
          <div class="commentimg">
            <img src="../../assets/images/micro_communities/detail_comment@2x.png"
                 alt=""/>
          </div>
      ...
      <div class="replyComment">
        ...
        <div class="bottom">
          <textarea v-model="replyContent"
                    placeholder="请输入你的回复吧"></textarea>
          <div class="replysubmit"
               @click="replySubmitBtn">发送
          </div>
        </div>
      </div>
    </van-popup>
    <van-popup v-model="adminOperationshow"
               position="bottom"
               :overlay="true">
      <div class="adminOperation">
        <div class="recommend">
          <div class="recommend_left">
            <img src="../../assets/images/micro_communities/detail_recommend@2x.png"
                 alt=""/>
          </div>
        ...
        <div class="top_set">
          <div class="top_set_left">
            <img src="../../assets/images/micro_communities/detail_roof@2x.png"
                 alt=""/>
          </div>
          <div class="top_set_right"
               @click="adminBtn(2)">置顶
          </div>
        </div>
        <div class="top_set"
             v-if="is_own">
          <div class="top_set_left">
            <img src="../../assets/images/micro_communities/detail_revise@2x.png"
                 alt=""/>
          </div>
          <div class="top_set_right"
               @click="reEditBtn">修改
        ...
        <div class="delete"
          ...
          <div class="delete_left">
            <img src="../../assets/images/micro_communities/detail_delect@2x.png"
                 alt=""/>
          </div>
    ...
    <van-popup v-model="releaseOperationshow"
               position="bottom"
               :overlay="true">
      <div class="releaseOperation">
        ...
        <div class="cancel"
             @click="reCancelBtn">取消
        </div>
      </div>
    </van-popup>
    <van-popup v-model="amountRewardshow"
               position="bottom"
               :overlay="true">
      <div class="amountReward">
        <div class="close"
             @click="amountRewardshow = false">
          <img src="../../assets/images/micro_communities/detail_clost@2x.png"
               alt=""/>
        </div>
        ...
        <div class="listAmounts">
          ...
          <ul>
            <li v-for="(item, index) in rewardArr"
                :key='index'
                :class="{ sel: rewardArrselect == index }"
                @click="shorewardArrBtn(index)">
              ¥{{ item.name }}
              <div class="selimg"
                   v-if="rewardArrselect == index">
                <img src="../../assets/images/micro_communities/detail_btn_cur@2x.png"
                     alt=""/>
              </div>
            </li>
          </ul>
        ...
        <div class="confirmReward"
             @click="confirmRewardBtn">确认打赏
        </div>
      </div>
    </van-popup>
    ...
    <van-popup v-model="commentManagement"
               position="bottom"
               :overlay="true">
      <div class="rewardPay">
        <div class="content">
