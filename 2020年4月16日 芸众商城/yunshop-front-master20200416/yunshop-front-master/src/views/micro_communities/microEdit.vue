...
">
        ...
        <van-popup :overlay="false" v-model="addgoodslistshow" position="right" style="width: 100%;height: 100%">
            <div class="addgoodslist">
                ...
                <mt-loadmore :top-method='loadTop' :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" bottomPullText="" bottomDropText="下拉加载" bottomLoadingText="" topDropText="释放刷新" ref="loadmore">
