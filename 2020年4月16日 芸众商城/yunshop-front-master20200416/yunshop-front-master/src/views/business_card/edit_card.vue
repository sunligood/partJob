  ...
  <div>
      ...
      <div class="content">
            ...
            <yd-cell-group>
              <yd-cell-item arrow>
                ...
                <span slot="right"
                  ...
                  <van-uploader :after-read="onRead"
                    ...
                    <img v-if="!form.card_avatar"
                         src="../../assets/images/photo-mr.jpg" />
                    <img v-if="imageUrl"
                         :src="imageUrl"
                         alt="头像" />
                    <img v-if="form.card_avatar"
                         :src="form.card_avatar"
                         alt="头像" />
                  </van-uploader>
                </span>
              </yd-cell-item>
              <yd-cell-item>
                <span slot="left">姓名<i class="iconfont icon-info-must"></i></span>
                <yd-input slot="right"
                          required
              ...
              <yd-cell-item>
                ...
                <yd-input slot="right"
                          ...
                          max="20"
                          placeholder="请输入公司名"></yd-input>
              </yd-cell-item>
              <yd-cell-item arrow>
                <span slot="left">角色选择：</span>
                <input slot="right"
                       type="text"
        ...
        <div class="recom_goods"
          ...
          <div class="goods_list">
            <div class="goods_box"
                 v-for="(item,i) in chooseItem" :key='i'>
              <div class="goods_img">
                <img :src="item.thumb" />
              </div>
              <ul class="goods_text">
                ...
                <li class="sum">
                  ...
                  <i class="iconfont icon-delete"
                     @click="deleteGoods(item.id)"></i>
                </li>
              </ul>
            </div>
            <div class="goods_box"
                 v-if="chooseItem.length <= 0">
    ...
    <transition name="move">
      <div class="m-dialog1"
        ...
        <yd-cell-item v-for="(item,i) in districtVal" :key='i'
