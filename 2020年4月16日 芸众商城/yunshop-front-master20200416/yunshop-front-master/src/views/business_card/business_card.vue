<template>
  <div id="card_conter">
    ...
    <div class="navBox">
      <van-tabs v-model="istapBtn" swipeable animated color='#50a6f9' @change='tabChange' @click="tabclick">
        ...
        <van-tab title="我的帖子" name="postMy" v-if="is_trick == 1">
          <div class="tab_post" :class="isintro?'':'boxHight'">
        ...
        <van-tab title="精选文章" name="text" v-if="is_article == 1">
          <div class="choiceness_text" :class="isintro?'':'boxHight'">
            <div class="text_box" v-for="(item,index) in isArticle" :key='index' @click="toxiangq(item,'text')">
                <div class="intext_box">
                  <div class="intext_left">
                    <p>{{item.title}}</p>
                    <div class="intext_left_bottom">
                      <span style="margin-right:0.406rem">{{item.author}}</span>|
                      <span style="margin-left:0.406rem">2020-01-08</span>
                    </div>
                  </div>
      ...
      <div class="goods_list">
        <div class="goods_box" v-for="(item,i) in store_good" :key='i' @click="toGood(item)">
          ...
          <ul class="goods_text">
            ...
            <li class="price">
              <span class="price_a"><font>¥</font>{{ item.price }}</span>
              <span class="price_b">¥{{ item.market_price }}</span>
            </li>
          </ul>
        </div>
            ...
            <div class="coupon_bg" v-for="(item,index) in coupon_list" :key='index'
              ...
              <ul class="coupon_info">
                ...
                <li class="info_bottom">
                  <div>
                    <span v-if="item.coupon_method===1">¥</span><font v-if="item.coupon_method===1">{{item.deduct}}</font>
                    <font v-if="item.coupon_method===2">{{item.discount}}</font><span v-if="item.coupon_method===2">折</span>
                  </div>
                  <div style="background:#cccccc" class="receive"
      ...
      <div class="goods_list">
        <div class="goods_box" v-for="(item,i) in goods" :key='i' @click="toGood(item)">
          ...
          <ul class="goods_text">
            ...
            <li class="price">
              <font>¥<span class="price_a">{{ item.price }}</span></font>
              <div class="price_b">
...
#card_conter {
  ...
  .navBox{
    ...
    // 贴子和视频
    .tab_post{
      margin: 0rem 0.938rem 0.628rem 0.938rem;
      // background: #50a6f9;
      overflow: hidden;
      position: relative;
      .centen_box{
        ...
        .show_box{
          ...
          height: 18rem;
          background-color: #ffffff;
          box-shadow: 0rem 0rem 0.656rem 0rem
            rgba(0, 0, 0, 0.1);
