<template>
  ...
  <div id="details">
    ...
    <div class="tbs">
      <div class="number"
           style="flex: 100%;"><span style="color:#8c8c8c">{{this.fun.initWithdrawal()}}编号</span><span>{{withdraw_sn}}</span></div>
      <div class="left"
      ...
      <div class="left"
           style="flex: 20%;">{{this.fun.initWithdrawal()}}时间</div>
      <div class="right"
           style="flex: 80%;">{{created_at}}</div>
    ...
    <div class="tbs"
      ...
      <div class="left"
           style="flex: 40%;">计算金额: {{item.commission_amount}}元</div>
      <div class="right"
           style="flex: 60%;">结算方式: {{item.formula}}</div>
      <div class="left"
           style="flex: 40%;">佣金: {{item.commission}}元</div>
      <div class="right"
           style="flex: 60%;">比例: {{item.commission_rate}}%</div>
