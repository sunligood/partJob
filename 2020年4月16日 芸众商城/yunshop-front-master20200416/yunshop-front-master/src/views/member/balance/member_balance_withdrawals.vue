  ...
  <div id="balance_recharge">
    ...
    <div class="content">
      ...
      <div class="transfer_sum">
        <span>{{ supplier ? "手续费" : `${fun.initWithdrawal()}金额` }}</span>
        <div class="sum">
          <div v-if="supplier">
            <!--需要加个参数判断手续费是百分比还是金额-->
            <em v-if="service_type == 0">¥</em><input type="number"
        ...
        <p v-if="withdraw_multiple != 1"
           style="border:none;line-height:1rem;">提现金额需要是 <em style="font-weight:bold;">{{withdraw_multiple}}</em> 的整倍数</p>
      </div>
    ...
    <yd-popup v-model="show2"
      ...
      <div class="withdrawal_box">
        ...
        <div class="recharge_way">
          <div style="display: flex;align-items: center;justify-content: space-between;padding: 20px 10px;border-bottom:1px solid #fafafa"
               @click="gotoList">
