  ...
  <div id="goodsinfo"
      ...
      <ul class="addr-info">
        <template v-if="
            orderType == 'DeliveryReplenish' &&
              !this.fun.isTextEmpty(this.service_station)
          ">
          <i class="iconfont icon-dingwei"></i>
          <li style="margin-bottom:0.5rem;font-size:16px;">
            服务站：{{ service_station.service_name }}&nbsp;&nbsp;&nbsp;（{{
              service_station.mobile
            }}）
          </li>
          <li style="color:#999">
        ...
        <template v-if="
            order_data.dispatch_type_id == 8 &&
              !this.fun.isTextEmpty(order_data.package_deliver)
          ">
          <li style="margin-bottom:0.5rem;font-size:14px;">
            提货人：{{ receiver }}&nbsp;&nbsp;&nbsp;{{ mobile }}
          </li>
          <li style="margin-bottom:0.5rem;font-size:14px;">
            提货点：{{ package_deliver.deliver_name }}&nbsp;&nbsp;&nbsp;{{
              package_deliver.deliver_mobile
            }}
          </li>
          <li style="color:#333">
            <i class="iconfont icon-dingwei"></i>
        ...
        <template v-if="order_data.dispatch_type_id != 8">
          ...
          <li style="color:#999">
            <span v-if="orderType == 'hotel'"
                  style="margin-right:0.3125rem">
              {{ hotel_name | escapeTitle }} </span>{{ address }}
          </li>
        </template>
      </ul>
    ...
    <div class="goods"
      ...
      <ul class="inner">
        ...
        <li class="option"
            v-show="order_data.is_virtual == 0">
          规格: {{ good.goods_option_title }}
        </li>
        <li class="option"
            style="margin-top: 2px"
            v-if="order_data.plugin_id == 40">
          押金:
        </li>
      </ul>
      <ul class="price">
    ...
    <div class="tbs">
      ...
      <div id="discount">
        ...
        <template v-for="item in order_data.order_fees">
          <ul class="Discount">
      ...
      <ul class="Real-pay">
        ...
        <li class="left"
            v-if="order_data.plugin_id == 40">
          合计:（押金￥{{ order_data.lease_toy.deposit_total }}可退）:
        </li>
    ...
    <van-popup v-model="showDFData"
               position="bottom" closeable round
               :overlay="true" :style="{ height: '80%' }">
