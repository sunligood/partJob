...
export default {
  ...
  data() {
    return {
      ...
      year_sales:'',
      month_sales:'',
      currentDate:String(new Date().getFullYear())+'-'+String(new Date().getMonth()+1>9?new Date().getMonth()+1:'0'+String(new Date().getMonth()+1)),
      currentDate2:String(new Date().getFullYear())+'-'+'01',
      empower: [
        {
          id: 1,
          name: "按月",
  ...
  methods: {
    initData(){
      this.id='1';
      this.currentDate=String(new Date().getFullYear())+'-'+String(new Date().getMonth()+1>9?new Date().getMonth()+1:'0'+String(new Date().getMonth()+1));
      this.currentDate2=String(new Date().getFullYear())+'-'+'01';
      this.empower=[
        {
          id: 1,
          name: "按月",
